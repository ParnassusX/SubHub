    ...
    <div className="min-h-screen bg-[#0f1a24] flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-white mb-2">Welcome to SubHub</h1>
          <p className="text-gray-400">Sign in to manage your subscriptions</p>
        </div>

        <div className="bg-[#20364b] rounded-xl border border-[#2e4e6b] p-8">
          ...
          <div className="mt-6 p-4 bg-gray-800 rounded-lg">
            <p className="text-gray-300 text-sm font-medium mb-2">New to SubHub?</p>
            <p className="text-gray-400 text-xs">Create an account to start tracking your subscriptions and get insights into your spending patterns.</p>
          </div>
        </div>
      </div>
    </div>
